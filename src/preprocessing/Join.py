...
class Join:
    ...
    def inner_join(df_1, df_2):
        ...
        return inner_join_df.join(df_2, on=df_1.index.name, how='inner')

    @staticmethod
    def left_join(df_1, df_2):
        left_join_df = df_1.copy()
        return left_join_df.join(df_2, on=df_1.index.name, how='left')

    @staticmethod
    def right_join(df_1, df_2):
        right_join_df = df_1.copy()
        return right_join_df.join(df_2, on=df_1.index.name, how='right')
